...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/chmps.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getChampionsData = getChampionsData;
...
function getChampionsData() {
  return _getChampionsData.apply(this, arguments);
}
function _getChampionsData() {
  _getChampionsData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch('https://ddragon.leagueoflegends.com/cdn/13.18.1/data/es_ES/champion.json');
        case 3:
        ...
        case 10:
          ...
          console.error('Error al cargar los campeones:', _context.t0);
          throw _context.t0;
        case 14:
        case "end":
...
// Importa la función desde api.js

document.getElementById('button').addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var gridContainer, champions, errorMessage;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        // Limpiar cualquier contenido anterior (si es necesario)
        gridContainer = document.getElementById('champion-grid');
        ...
        _context.prev = 2;
        _context.next = 5;
        return (0, _chmps.getChampionsData)();
      case 5:
        champions = _context.sent;
        // Iteramos sobre los campeones y generamos las tarjetas
        Object.values(champions).forEach(function (champion) {
          ...
          championImg.src = "https://ddragon.leagueoflegends.com/cdn/13.18.1/img/champion/".concat(champion.id, ".png");
          championImg.alt = champion.name;

          // Crear el nombre y la descripción del campeón
          var championInfo = document.createElement('div');
          championInfo.classList.add('champion-info');
          var championName = document.createElement('h3');
          championName.textContent = champion.name;
          var championDesc = document.createElement('p');
          ...
          attackItem.textContent = "Ataque: ".concat(champion.info.attack);
          var defenseItem = document.createElement('li');
          defenseItem.textContent = "Defensa: ".concat(champion.info.defense);
          var magicItem = document.createElement('li');
          magicItem.textContent = "Magia: ".concat(champion.info.magic);
          var difficultyItem = document.createElement('li');
          difficultyItem.textContent = "Dificultad: ".concat(champion.info.difficulty);
          var tagsItem = document.createElement('li');
          tagsItem.textContent = "Roles: ".concat(champion.tags);
...
},{"./chmps.js":"js/chmps.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
